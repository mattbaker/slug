defmodule Slug.Slack do
  ...
  @doc false
  def start_link([]) do
    token = Slug.Util.get_api_token(:web_api)
  ...
  ```
  {url, bot_id, bot_name} = Slug.Slack.get_rtm_connection("xo-my-token")
  ```
  """
  ...
  Slug.Slack.add_reaction(msg.channel, msg.ts, "thumbsup")
  ```
  """
